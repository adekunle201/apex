...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(960446583750375663)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(960446747132375666)
,p_plugin_id=>wwv_flow_imp.id(960446583750375663)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(960447139372375673)
,p_plugin_id=>wwv_flow_imp.id(960446583750375663)
,p_attribute_scope=>'COMPONENT'
