...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16161432915806608)
...
'</p>',
''))
,p_plug_required_role=>wwv_flow_imp.id(1254109290491918041)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(19087614188343934)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(19088635705343940)
,p_plug_name=>'My Workflows - Smart Filters'
,p_parent_plug_id=>wwv_flow_imp.id(19087614188343934)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>10
,p_plug_display_point=>'SMART_FILTERS'
,p_plug_source_type=>'NATIVE_SMART_FILTERS'
,p_filtered_region_id=>wwv_flow_imp.id(19088824302343940)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(19088824302343940)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19091855704343956)
,p_name=>'WORKFLOW_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19092360639343957)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19092835364343957)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19093389464343957)
,p_name=>'TITLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19093910676343958)
,p_name=>'INITIATOR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19094401944343958)
,p_name=>'STATE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19094889539343958)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19095368439343958)
,p_name=>'CREATED_AGO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19095879938343959)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19096422922343959)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19096867527343959)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(19097347495343959)
,p_name=>'BADGE_STATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(20109540330608706)
,p_name=>'MAP_URL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19088277698343938)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19089161926343946)
,p_name=>'P19_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(19088635705343940)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19089546758343947)
,p_name=>'P19_TYPE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19089968157343948)
,p_name=>'P19_STATE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(19088635705343940)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19090347367343949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19090790065343950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19091165413343951)
...
,p_lov=>'.'||wwv_flow_imp.id(1510156706296847288)||'.'
,p_item_template_options=>'#DEFAULT#'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'manual_entry', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19098903238343963)
,p_name=>'P19_SORT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(19088824302343940)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(19102190996343970)
,p_name=>'Refresh - My Workflows - Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(19088824302343940)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19102610143343970)
,p_event_id=>wwv_flow_imp.id(19102190996343970)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(19088824302343940)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19103085523343971)
,p_event_id=>wwv_flow_imp.id(19102190996343970)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(19088635705343940)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(19099239233343966)
,p_name=>'Terminate'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19099664769343967)
,p_event_id=>wwv_flow_imp.id(19099239233343966)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19100170362343967)
,p_event_id=>wwv_flow_imp.id(19099239233343966)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_02=>'P19_WORKFLOW_ID'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19100685570343968)
,p_event_id=>wwv_flow_imp.id(19099239233343966)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19101142416343969)
,p_event_id=>wwv_flow_imp.id(19099239233343966)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19101710813343969)
,p_event_id=>wwv_flow_imp.id(19099239233343966)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(19097841630343959)
,p_region_id=>wwv_flow_imp.id(19088824302343940)
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(19098359730343961)
,p_region_id=>wwv_flow_imp.id(19088824302343940)
