...
/
  ...
  ;
/-- Failed to get DDL ORA-31603: object "ISEQ$$_80896" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80898" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80900" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80903" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80906" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80911" of type SEQUENCE not found in schema "CICD"-- Failed to get DDL ORA-31603: object "ISEQ$$_80914" of type SEQUENCE not found in schema "CICD"
...
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "CICD"."EBA_DEMO_APPR" as
    ...
    c_app_id       constant varchar2(6) := 'APP_ID';    procedure update_laptop_request(
                p_id                      in number,
                p_status                  in varchar2 default null,
                p_workflow_id             in number   default null,
                p_approval_task_id        in number   default null,
    ...
    begin
       update EBA_DEMO_APPR_LAPTOP_REQUESTS
        ...
        where id                      = p_id;
       commit;
    end update_laptop_request;    function get_participant_for_role(
                p_task_def_static_id in varchar2,
                p_job                in varchar2,
                p_proposed_sal       in number,
                p_role               in varchar2)
    ...
    begin
        ...
        return l_ret;
    end get_participant_for_role;    function get_approver_for(
                p_task_def_static_id in varchar2,
                p_empno              in number,
                p_job                in varchar2,
                p_proposed_sal       in number)
    ...
    begin
        return get_participant_for_role(p_task_def_static_id,
                                        ...
                                        p_proposed_sal,
                                        'APPROVER');
    end get_approver_for;    function get_admin_for(
                p_task_def_static_id in varchar2,
                p_job                in varchar2,
                p_proposed_sal       in number)
                return                  varchar2
    ...
    begin
        return get_participant_for_role(p_task_def_static_id,
                                        ...
                                        p_proposed_sal,
                                        'ADMIN');
    end get_admin_for;    function get_admin_for(
                p_task_def_static_id in varchar2,
                p_empno              in number,
                p_job                in varchar2,
                p_proposed_sal       in number)
    ...
    begin
        return get_participant_for_role(p_task_def_static_id,
                                        ...
                                        p_proposed_sal,
                                        'ADMIN');
    end get_admin_for;    function user_has_open_approvals
                return boolean is
    ...
    begin
        ...
        return false;
    end user_has_open_approvals;    function user_has_open_admin_tasks
                return boolean is
        l_app_user varchar2(30) := apex_application.g_user;
    begin
        for j in (select null
        ...
        return false;
    end user_has_open_admin_tasks;    function details_task_url(
                p_app_id  in number,
                p_task_id in number,
                p_url     in varchar2)
                return       varchar2
    ...
    begin
        return apex_plugin_util.replace_substitutions (
                    ...
                    p_escape => false);
    end details_task_url;    procedure validate_admin_and_approver(
                p_task_def_static_id in varchar2,
                p_empno              in number,
                p_proposed_sal       in number,
                p_admin             out varchar2,
    ...
    begin
        ...
        return l_ret;
    end admins_for_task;    function approvers_for_task(
                p_task_id in number)
                return       varchar2
    is
        l_ret varchar2(2000);
    begin
        ...
        return l_ret;
    end approvers_for_task;    function get_laptop_approver(
    ...
    end get_laptop_approver;    function get_appraisal_participant(
            p_appraisal_id in number)
            return            varchar2
    is
        l_ret varchar2(4000);
    ...
    exception
        when no_data_found then
            return null;
    end get_appraisal_participant;    function get_appraisal_manager(
                p_appraisal_id in number)
                return            varchar2
    is
        l_ret varchar2(4000);
    ...
    exception
        when no_data_found then
            return null;
    end get_appraisal_manager;    procedure determine_appraisal_vp(
                p_appraisal_id in number,
                p_vp_username  in out varchar2)
    is
    begin
    ...
    exception
        when no_data_found then
            null;
    end determine_appraisal_vp;    function mask_for_date_page_item(p_item_name varchar2) return varchar2 is
        l_mask varchar2(200);
    begin
    ...
    exception
        when no_data_found then
            return null;
    end taskdef_name;    procedure approval_vacation_handler(
                p_param    in apex_approval.t_vacation_rule_input,
                p_result  out apex_approval.t_vacation_rule_result)
    is
    ...
    end;    procedure appraisal_vp_review_handler(
                p_param    in apex_approval.t_vacation_rule_input,
                p_result  out apex_approval.t_vacation_rule_result)
    is
        l_participants     apex_t_varchar2;
    ...
    end appraisal_vp_review_handler;    function laptop_in_stock(
        p_laptop_type in varchar2)
        return           boolean
    is
    begin
        ...
        return false;
    end laptop_in_stock;    procedure deliver_laptop_from_stock(
        p_laptop_type       in varchar2,
        p_laptop_request_id in number)
    is
    begin
        update eba_demo_appr_laptop_stock
         ...
         update eba_demo_appr_laptop_requests
          ...
          where id = p_laptop_request_id;
    end deliver_laptop_from_stock;    procedure order_laptop_from_supplier(
        p_laptop_type       in varchar2,
        p_laptop_request_id in number)
    is
    begin
