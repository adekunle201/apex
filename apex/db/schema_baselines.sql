  ...
  CREATE TABLE "UAT"."EBA_DEMO_APPR_APPRAISALS"
...
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_APPROVERS"
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE,
...
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_DEPT"
...
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_EMP"
  ...
  USING INDEX  ENABLE,
	 CONSTRAINT "EBA_DEMO_APPR_WORKS_IN_DEPT" FOREIGN KEY ("DEPTNO")
	  REFERENCES "UAT"."EBA_DEMO_APPR_DEPT" ("DEPTNO") ON DELETE SET NULL ENABLE
   )  ROWDEPENDENCIES ;
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_LAPTOP_REQUESTS"
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE,
	"EMPNO" NUMBER NOT NULL ENABLE,
...
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_LAPTOP_STOCK"
...
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_SAL_HISTORY"
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE,
	"EMPNO" NUMBER,
	"NEW_SAL" NUMBER,
	"APPROVAL_DATE" DATE,
  ...
  USING INDEX  ENABLE,
	 CONSTRAINT "EBA_DEMO_APPR_SAL_EMPNO_FK" FOREIGN KEY ("EMPNO")
	  REFERENCES "UAT"."EBA_DEMO_APPR_EMP" ("EMPNO") ON DELETE CASCADE ENABLE
   ) ;
/
  CREATE TABLE "UAT"."EBA_DEMO_APPR_VACATION"
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE,
